...
fn expand_from_parsed(args: MacroArgs, extern_: Mod) -> proc_macro2::TokenStream {
    ...
    let reexports = quote! { #rustfoundry::reexports_for_macros };
    ...
    let metric_fields = fns.iter().map(|fn_| metric_field(rustfoundry, fn_));
    let label_set_structs = fns
        .iter()
        .filter_map(|fn_| label_set_struct(rustfoundry, fn_));
    ...
    let registry_init = |var: &str, kind: &str| {
        ...
        quote! {
            let #var = &mut *#rustfoundry::telemetry::metrics::internal::Registries::#method(stringify!(#mod_name));
        }
    };
    ...
    let metric_inits = fns.iter().map(|fn_| metric_init(rustfoundry, fn_));

    let metric_fns = fns
        .iter()
        .map(|fn_| metric_fn(rustfoundry, &metrics_struct, fn_));
...
fn metric_field(rustfoundry: &Path, fn_: &ItemFn) -> proc_macro2::TokenStream {
    let ItemFn {
    ...
    {
        quote! {
            #rustfoundry::reexports_for_macros::prometools::serde::Family<
                #metric_name,
                #metric_ty,
                #ctor_path,
            >
...
fn label_set_struct(rustfoundry: &Path, fn_: &ItemFn) -> Option<proc_macro2::TokenStream> {
    let ItemFn {
        attrs: FnAttrs { cfg, .. },
        args,
    ...
    let serde_with = quote! { #rustfoundry::reexports_for_macros::serde_with };
    ...
    let serde = quote! { #rustfoundry::reexports_for_macros::serde };
...
fn metric_init(rustfoundry: &Path, fn_: &ItemFn) -> proc_macro2::TokenStream {
    let ItemFn {
        attrs:
            FnAttrs {
                cfg,
...
fn metric_fn(rustfoundry: &Path, metrics_struct: &Ident, fn_: &ItemFn) -> proc_macro2::TokenStream {
    let ItemFn {
    ...
    let fn_body = if args.is_empty() {
        ...
        quote! {
            ::std::clone::Clone::clone(
                &#rustfoundry::reexports_for_macros::prometools::serde::Family::get_or_create(
    ...
    fn expand_empty() {
        ...
        let expected = code_str! {
            ...
            mod empty {
                ...
                #[allow(non_upper_case_globals)]
                static __empty_Metrics: ::rustfoundry::reexports_for_macros::once_cell::sync::Lazy<__empty_Metrics> =
                    ::rustfoundry::reexports_for_macros::once_cell::sync::Lazy::new(|| { __empty_Metrics {} });
            }
        };
    ...
    fn expand_simple_optional_only() {
        ...
        let expected = code_str! {
            pub(crate) mod oxy {
                ...
                #[allow(non_upper_case_globals)]
                static __oxy_Metrics: ::rustfoundry::reexports_for_macros::once_cell::sync::Lazy<__oxy_Metrics> =
                    ::rustfoundry::reexports_for_macros::once_cell::sync::Lazy::new(|| {
                        let opt_registry = &mut *::rustfoundry::telemetry::metrics::internal::Registries::get_opt_subsystem(stringify!(oxy));

                        __oxy_Metrics {
                            connections_total: {
                                let metric = ::std::default::Default::default();

                                ::rustfoundry::reexports_for_macros::prometheus_client::registry::Registry::register(
                                    opt_registry,
                                    ::std::stringify!(connections_total),
                                    str::trim(" Total number of connections"),
                                    ::std::boxed::Box::new(::std::clone::Clone::clone(&metric))
    ...
    fn expand_label_set() {
        ...
        let expected = code_str! {
            pub mod oxy {
                ...
                #[allow(non_camel_case_types)]
                #[::rustfoundry::reexports_for_macros::serde_with::serde_as(crate = ":: rustfoundry :: reexports_for_macros :: serde_with")]
                #[derive(
                    ::std::clone::Clone,
                    ::std::cmp::Eq,
                    ::std::hash::Hash,
                    ::std::cmp::PartialEq,
                    ::rustfoundry::reexports_for_macros::serde::Serialize,
                )]
                #[serde(crate = ":: rustfoundry :: reexports_for_macros :: serde")]
                ...
                static __oxy_Metrics: ::rustfoundry::reexports_for_macros::once_cell::sync::Lazy<__oxy_Metrics> =
                    ::rustfoundry::reexports_for_macros::once_cell::sync::Lazy::new(|| {
                        let registry = &mut *::rustfoundry::telemetry::metrics::internal::Registries::get_main_subsystem(stringify!(oxy));
            ...
            pub mod oxy {
                ...
                static __oxy_Metrics: ::rustfoundry::reexports_for_macros::once_cell::sync::Lazy<__oxy_Metrics> =
                    ::rustfoundry::reexports_for_macros::once_cell::sync::Lazy::new(|| {
                        ...
                        __oxy_Metrics {
                            connections_latency: {
                                let metric = ::rustfoundry::reexports_for_macros::prometheus_client::metrics::family::MetricConstructor::new_metric(
                            ...
                            requests_per_connection: {
                                let metric = ::rustfoundry::reexports_for_macros::prometools::serde::Family::new_with_constructor(
