...
mod tests {
    ...
    fn expand_structure() {
        ...
        let expected = code_str! {
            #[derive(
                ...
                ::rustfoundry::reexports_for_macros::serde::Deserialize,
            )]
            #[derive(Debug)]
            ...
            impl ::rustfoundry::settings::Settings for TestStruct {
                fn add_docs(
                    &self,
                    parent_key: &[String],
                    docs: &mut ::std::collections::HashMap<Vec<String>, &'static [&'static str]>
                    ...
                    ::rustfoundry::settings::Settings::add_docs(&self.boolean, &key, docs);
                    docs.insert(key, &[r" A boolean value.",][..]);
                    let mut key = parent_key.to_vec();
                    key.push("integer".into());
                    ::rustfoundry::settings::Settings::add_docs(&self.integer, &key, docs);
    ...
    fn expand_enum() {
        ...
        let expected = code_str! {
            ...
            impl ::rustfoundry::settings::Settings for TestEnum { }
        };
