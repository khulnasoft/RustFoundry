...
fn expand_from_parsed(args: MacroArgs, struct_: Struct) -> Result<proc_macro2::TokenStream> {
    ...
    Ok(quote! {
        ...
        #(#cfg)*
        impl #rustfoundry::telemetry::metrics::InfoMetric for #struct_name {
...
mod tests {
    ...
    fn expand_empty() {
        ...
        let expected = code_str! {
            ...
            #[derive(::rustfoundry::reexports_for_macros::serde::Serialize)]
            #[serde(crate = ":: rustfoundry :: reexports_for_macros :: serde")]
            struct SomeInfoMetric {}

            impl ::rustfoundry::telemetry::metrics::InfoMetric for SomeInfoMetric {
