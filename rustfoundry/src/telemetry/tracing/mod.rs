...
pub use rustfoundry_macros::span_fn;
...
/// ```
/// use rustfoundry::telemetry::TelemetryContext;
/// use rustfoundry::telemetry::tracing::{self, test_trace, SerializableTraceState, StartTraceOptions};
///
/// // Test context is used for demonstration purposes to show the resulting traces.
/// let ctx = TelemetryContext::test();
/// let _scope = ctx.scope();
...
/// ```
/// use rustfoundry::telemetry::TelemetryContext;
/// use rustfoundry::telemetry::tracing::{self, test_trace, StartTraceOptions};
///
/// // Test context is used for demonstration purposes to show the resulting traces.
/// let ctx = TelemetryContext::test();
/// let _scope = ctx.scope();
...
/// Returns the current span as a raw [rustracing] crate's `Span` that is used by Rustfoundry internally.
///
/// Can be used to propagate the tracing context to libraries that don't use Rustfoundry'
/// telemetry.
///
...
/// ```
/// use rustfoundry::telemetry::TelemetryContext;
/// use rustfoundry::telemetry::tracing::{self, test_trace, TestTraceOptions};
///
/// // Test context is used for demonstration purposes to show the resulting traces.
/// let ctx = TelemetryContext::test();
///
...
/// # Examples
/// ```
/// use rustfoundry::telemetry::tracing::{test_trace, TestSpan, TestTrace};
/// use std::time::SystemTime;
///
...
///
/// ```
/// use rustfoundry::telemetry::tracing::{test_trace, TagValue, TestSpan, TestTrace};
/// use std::time::SystemTime;
///
/// let trace = test_trace! {
///     "root"; {
