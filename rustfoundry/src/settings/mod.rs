...
//!
//! Rustfoundry provides API to generate YAML-serializable documented settings for a service. Such
...
//! standalone as well.
//!
//! Rustfoundry automatically implements [`Settings`] trait for structures or enums annotated with
...
//!
//! Rustfoundry' settings philosophy is that service should always have default configuration that
...
//!
//! The other important requirement of Rustfoundry' settings is to present as much documentation for
...
//!
//! ```no_run
//! # use rustfoundry::settings::settings;
//! #
//! #[settings]
//! struct TlsSettings {
...
//!     addr: rustfoundry::settings::net::SocketAddr,
//!
//!     /// TLS settings
...
//!
//! Even though Rustfoundry strives to implement the [`Settings`] trait for most commonly used types,
...
/// # Example
/// ```
/// use rustfoundry::settings::{to_yaml_string, settings};
///
/// #[settings]
/// struct NestedStruct {
///     /// A field.
...
pub use rustfoundry_macros::settings;
...
pub trait Settings: Default + Clone + Serialize + DeserializeOwned + Debug + 'static {
    ...
    /// # Examples
    /// ```
    /// use rustfoundry::settings::{Settings, to_yaml_string};
