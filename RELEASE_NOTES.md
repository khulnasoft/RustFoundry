...
- 2024-10-31 Allow opting out of settings deny_unknown_fields for rustfoundry internal structs (#85)
...
- 2024-01-26 Merge pull request #2 from khulnasoft/android-ci
...
- 2023-06-15 Add a few more common allow lists used by Khulnasoft apps
